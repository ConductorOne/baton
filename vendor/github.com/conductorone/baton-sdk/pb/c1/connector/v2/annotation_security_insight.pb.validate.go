...
// Validate checks the field values on RiskFactor with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *RiskFactor) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RiskFactor with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in RiskFactorMultiError, or
// nil if none found.
func (m *RiskFactor) ValidateAll() error {
	return m.validate(true)
}

func (m *RiskFactor) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RiskFactorMultiError(errors)
	}

	return nil
}

// RiskFactorMultiError is an error wrapping multiple validation errors
// returned by RiskFactor.ValidateAll() if the designated constraints aren't met.
type RiskFactorMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RiskFactorMultiError) Error() string {
...
func (m RiskFactorMultiError) AllErrors() []error { return m }

// RiskFactorValidationError is the validation error returned by
// RiskFactor.Validate if the designated constraints aren't met.
type RiskFactorValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e RiskFactorValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RiskFactorValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RiskFactorValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RiskFactorValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RiskFactorValidationError) ErrorName() string { return "RiskFactorValidationError" }

// Error satisfies the builtin error interface
func (e RiskFactorValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = RiskFactorValidationError{}
...
func (m *RiskScore) validate(all bool) error {
	...
	if val := m.GetNormalizedScore(); val < 0 || val > 100 {
		err := RiskScoreValidationError{
	...
	// no validation rules for SourceScore

	for idx, item := range m.GetRiskFactors() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, RiskScoreValidationError{
						field:  fmt.Sprintf("RiskFactors[%v]", idx),
			...
			if err := v.Validate(); err != nil {
				return RiskScoreValidationError{
					field:  fmt.Sprintf("RiskFactors[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
